  ...
  return (
    <section>
      <div className="card">
        ...
        <p>
          {isAdmin
            ? 'Admin access: you can create, edit, and delete official beginner decks for everyone.'
            : 'Standard access: you can browse official beginner decks and read their flashcards, but you cannot modify them.'}
        </p>
      </div>
