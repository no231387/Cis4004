  ...
  return (
    <section className="import-page">
      <div className="card">
        ...
        <p>
          {isAdmin
            ? 'Paste CSV or tab-separated text, or upload a file, then preview cards before importing for the full system view.'
            : 'Paste CSV or tab-separated text, or upload a file, then preview cards before importing into your own flashcard collection.'}
        </p>
      </div>
